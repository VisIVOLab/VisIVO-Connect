...
class SessionFakeRenderer:
    ...
    def get_volume_params(self) -> dict[str, Any]:
        return {
            ...
            "palettePreviewColors": [
                "rgba(0, 0, 4, 1.000)",
                "rgba(65, 9, 103, 1.000)",
                "rgba(147, 37, 103, 1.000)",
                "rgba(221, 81, 58, 1.000)",
                "rgba(252, 197, 38, 1.000)",
                "rgba(252, 255, 164, 1.000)",
            ],
            "availablePalettes": ["Inferno", "Viridis"],
            "opacityScale": 1.0,
    ...
    def get_runtime_capabilities(self) -> dict[str, Any]:
        return {
            ...
            "scaleMode": "linear",
            "paletteCatalog": [
                {"name": "Inferno", "sampleCount": 256, "hasAlpha": False, "kind": "table"},
                {"name": "Viridis", "sampleCount": 256, "hasAlpha": False, "kind": "table"},
            ],
                "paletteApplication": {
                    "palette": "Inferno",
